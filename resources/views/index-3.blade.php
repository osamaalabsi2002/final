    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            ...
            <img class="logo-abbr" src="{{ asset('asset/images/logo-white.png') }}" alt="">
<img class="logo-compact" src="{{ asset('asset/images/logo-text-white.png') }}" alt="">
<img class="brand-title" src="{{ asset('asset/images/logo-text-white.png') }}" alt="">
            ...
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">Emloyeer</span>
						</a>
                        <ul aria-expanded="false">
                        <li><a href="{{ asset('/allEmployee') }}">All Employee</a></li>
                        <li><a href="{{ asset('/addEmployee') }}">Add Employee</a></li>

                            <li><a href="professor-profile.html">Employeer Profile</a></li>
                        </ul>
                    </li>
					...
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">Servive</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="all-courses.html">All Servive</a></li>
                            <li><a href="add-courses.html">Add Servive</a></li>
 
                            <li><a href="about-courses.html">About Servive</a></li>
                        </ul>
                    </li>
					...
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="all-departments.html">All Products</a></li>
                            <li><a href="add-departments.html">Add Products</a></li>
